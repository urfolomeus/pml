...
def load_images(filename):
    ...
    with gzip.open(filename, 'rb') as f:
        # Read the header information into a bunch of variable
...
def encode_fives(Y):
    # Convert all 5s to 1s and everything else to 0s
    return (Y == 5).astype(int)


# 60K labels, each with value 1 if the digit is a 5 or 0 otherwise
